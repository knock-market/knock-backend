...
import { ArrowLeft, Camera, Copy, Check, Share, Loader2 } from 'lucide-react';
            ...
            <div className="p-6 space-y-8">
                ...
                <div className="pt-4">
                    <button
                        ...
                        disabled={!name || isUploading || isSubmitting}
                        className={`w-full font-bold py-4 rounded-xl shadow-lg transition-all active:scale-[0.98] ${name && !isUploading && !isSubmitting
