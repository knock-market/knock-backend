...
class ItemControllerTest extends RestDocsTest {
        ...
        void createItem_success() {
                ...
                ItemCreateRequestDto request = new ItemCreateRequestDto(
                                TEST_GROUP_ID, TEST_ITEM_TITLE, TEST_ITEM_DESCRIPTION, TEST_ITEM_PRICE,
                                ItemType.SELL, ItemCategory.DIGITAL_DEVICE, List.of(TEST_IMAGE_URL));
                given(itemService.createItem(anyLong(), anyLong(), any()))
                                .willReturn(new ItemCreateResult(TEST_ITEM_ID));
        ...
        void getItem_success() {
                // given
                ItemReadResult result = new ItemReadResult(
                                TEST_ITEM_ID, TEST_ITEM_TITLE, TEST_ITEM_DESCRIPTION, TEST_ITEM_PRICE,
                                ItemType.SELL, ItemCategory.DIGITAL_DEVICE, ItemStatus.ON_SALE, List.of(TEST_IMAGE_URL),
                                TEST_MEMBER_ID);
        ...
        void getItemsByGroup_success() {
                ...
                ItemListResult result = new ItemListResult(
                                TEST_ITEM_ID, TEST_ITEM_TITLE, TEST_ITEM_PRICE, ItemType.SELL,
                ...
                // when & then
                restDocGiven()
                                .pathParam("groupId", TEST_GROUP_ID)
                                .get("/api/v1/groups/{groupId}/items")
                                .then()
                                .status(HttpStatus.OK)
                                .apply(document("api/v1/items/list-by-group", requestPreprocessor(),
        ...
        void getMySelling_success() {
                ...
                restDocGiven()
                                ...
                                .then()
                                .status(HttpStatus.OK)
                                .apply(document("api/v1/items/my-selling", requestPreprocessor(),
                                                responsePreprocessor(),
                                                relaxedResponseFields(
                                                                fieldWithPath("result").type(JsonFieldType.STRING)
                                                                                .description("결과 코드"),
