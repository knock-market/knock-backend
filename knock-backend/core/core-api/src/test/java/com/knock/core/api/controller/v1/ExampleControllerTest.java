...
//
// import com.knock.core.api.controller.v1.request.ExampleRequestDto;
// import com.knock.core.domain.ExampleResult;
// import com.knock.core.domain.ExampleService;
...
// requestFields(
// fieldWithPath("data").type(JsonFieldType.STRING).description("ExampleBody Data
// Field")),
// responseFields(fieldWithPath("result").type(JsonFieldType.STRING).description("ResultType"),
// fieldWithPath("data.result").type(JsonFieldType.STRING).description("Result Date"),
