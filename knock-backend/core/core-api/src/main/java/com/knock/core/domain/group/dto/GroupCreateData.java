...
public record GroupCreateData(String name, String description, String imageUrl) {
	public static GroupCreateData of(GroupCreateRequestDto request) {
		return new GroupCreateData(request.name(), request.description(), request.imageUrl());
	}
}
